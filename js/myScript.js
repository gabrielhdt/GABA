// TODO: ajouter des comments pour les fonctions : write_geoloc_fromodal,
// addRelationship
...
function myDelete(id_msg) {
  ...
  $.post('script/scriptAjax.php', {id : id_msg});
}
/*******************************
...
function language(lg) {
  $.post('script/scriptAjax.php', {lang : lg}, function success(data) {
